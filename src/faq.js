...
const FAQS = {
  ...
  assurance: [
    ...
    { q: 'Quelle est votre offre sur le pare-brise ?',
      a: 'Pour un remplacement pris en charge au titre de la garantie bris de glace, vous choisissez : votre franchise vous est remboursée par l’atelier, ou vous recevez une révision-vidange offerte. Dites-le avant la réparation : l’avantage est porté sur le devis puis sur la facture.',
